...
export function StaffProfileDashboardPage({
  ...
  const { activeAction, deleteStaff, isLoading, staffMembers, updateStaff, toggleStaffActive } =
    useAdminDashboard();
              ...
              <div>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  <div className="flex items-center gap-3">
                    <button
                      type="button"
                      onClick={() => toggleStaffActive(staffMember.id, staffMember.isActive)}
                    ...
                    <span
                      className={`text-[11px] font-bold uppercase tracking-[0.12em] ${
                        staffMember.isActive ? "text-emerald-700" : "text-slate-500"
                      }`}
                    >
      ...
      {isEditing ? (
        <div className="rounded-[26px] border border-slate-200 bg-white p-5 shadow-[0_15px_40px_rgba(15,23,42,0.08)]">
          ...
          <div className="mt-5 grid gap-4">
            ...
            <div className="flex items-center gap-2 mt-4 mb-2 pb-4 border-b border-slate-100">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-slate-500"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
              </div>
              <p className="text-sm font-bold text-slate-800">Contact & Photos</p>
            </div>
