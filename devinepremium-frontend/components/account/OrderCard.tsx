  ...
  return (
    <article className="overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-sm transition hover:shadow-md">
      <div 
        ...
        className="flex cursor-pointer flex-col gap-4 px-4 pb-4 pt-5 sm:px-6 sm:pt-6 md:flex-row md:items-start md:justify-between transition-colors hover:bg-slate-50/50"
      >
        ...
        <div className="flex flex-wrap items-center gap-2 md:justify-end">
          ...
          <div className="ml-2 flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-transform duration-200" style={{ transform: isExpanded ? 'rotate(180deg)' : 'rotate(0deg)' }}>
