...
function DashboardContent({ session }: { session: UserSession }) {
  ...
  if (isLoading) {
    return (
      <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-sm">
        Loading your booking dashboard...
      </div>
    );
  }
        ...
        {data?.bookings.length ? (
          ...
          <div className="rounded-[28px] border border-slate-200 bg-white p-10 text-center shadow-sm">
            ...
            <p className="mt-3 text-sm text-slate-600">
              Use the service booking pages with the same email, then come back
              here to track your history.
            </p>
          </div>
        )}
      </div>
      ...
      <main className="min-h-screen bg-slate-50 px-4 py-16">
        <div className="mx-auto max-w-3xl rounded-[32px] border border-slate-200 bg-white p-10 text-center shadow-sm">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-600">
            Sign in with your email account to view booking history and payment
            status.
          </p>
          <Link
            href="/login"
